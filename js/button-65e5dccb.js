import{C as o,A as n}from"./code-37b41cb6.js";import{d as r,r as i,c,a as t,b as s,w as p,e as d,o as l,f as a}from"./index-4e3a7888.js";const _=d('<h1>Button 按钮</h1><p>常用的操作按钮</p><h2>基础用法</h2><p>使用 <span class="lable-code">type</span>、 <span class="lable-code">size</span>、 <span class="lable-code">shape</span>、 <span class="lable-code">loading</span>、 <span class="lable-code">disabled</span> 来自定义按钮 </p>',4),u={class:"preview"},y={class:"p-r-1"},b={class:"p-r-1"},m={class:"p-r-1"},C={class:"p-r-1"},h={class:"p-r-1"},f={class:"m-t-1"},v={class:"p-r-1"},g={class:"p-r-1"},x={class:"p-r-1"},w={class:"m-t-1"},z={class:"p-r-1"},B={class:"p-r-1"},N={class:"p-r-1"},V={class:"m-t-1"},k={class:"p-r-1"},A={class:"p-r-1"},E=`<div>
